...
#define STRING_CONFIG_H_AUTHOR "(DanielBax, Viper)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -53, 15, -2 }
...
#define XY_PROBE_SPEED 8000      // (90*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_SPEED_FAST 220   // (3*60)
...
#define X_BED_SIZE 242.5
#define Y_BED_SIZE 244
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     PA_13       // LED driving pin
