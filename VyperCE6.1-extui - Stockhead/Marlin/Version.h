 ...
 */
    ...
    #ifdef VYPER_BUILD
        #define SHORT_BUILD_VERSION "Vyper-CE-6.1c+N"
    #elif defined VYPER_BUILD_LA
        #define SHORT_BUILD_VERSION "Vyper-CE-6.1c(LA+N)"
    #elif defined VYPER_BUILD_LA_T
        #define SHORT_BUILD_VERSION "Vyper-CE-6.1c(LA+T+N)"
    #elif defined VYPER_BUILD_LA_TE
        #define SHORT_BUILD_VERSION "Vyper-CE-6.1c(LA+TE+N)"
    #else
